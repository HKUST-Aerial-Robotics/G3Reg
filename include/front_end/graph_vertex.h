...
namespace clique_solver{
    ...
    public:
        ...
        GraphVertex() = default;
        GraphVertex(const Eigen::Vector3d& centroid, const VertexInfo& vertex_info):centroid(centroid),vertex_info_(vertex_info){
            covariance = Eigen::Matrix3d::Identity();
        }
        GraphVertex(const Eigen::Vector3d& centroid,const Eigen::Matrix3d& covariance,
                    const VertexInfo& vertex_info):centroid(centroid),covariance(covariance),vertex_info_(vertex_info){}
    ...
    public:
        ...
        PointVertex() = default;
        ~PointVertex() = default;
        PointVertex(const Eigen::Vector3d& centroid, const VertexInfo& vertex_info):GraphVertex(centroid,vertex_info){}
    ...
    public:
        ...
        ~PointRatioVertex() = default;
        PointRatioVertex(const Eigen::Vector3d& centroid,const VertexInfo& vertex_info):GraphVertex(centroid,vertex_info){}
